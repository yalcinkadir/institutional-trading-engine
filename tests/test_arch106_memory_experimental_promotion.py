...
from scripts.promote_arch106_memory_experimental_candidates import MEMORY_EXPERIMENTAL_CANDIDATES, promote_candidates
...
def test_arch106_memory_experimental_promotion_is_not_runtime(tmp_path: Path) -> None:
    repo = tmp_path
    for candidate in MEMORY_EXPERIMENTAL_CANDIDATES:
    ...
    assert classification["classified_modules"] == MEMORY_EXPERIMENTAL_CANDIDATES
