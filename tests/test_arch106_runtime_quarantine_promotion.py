...
from scripts.promote_arch106_runtime_quarantine_candidates import RUNTIME_QUARANTINE_CANDIDATES, promote_candidates
...
def test_arch106_runtime_quarantine_promotion_is_isolated_not_runtime(tmp_path: Path) -> None:
    repo = tmp_path
    for candidate in RUNTIME_QUARANTINE_CANDIDATES:
    ...
    assert classification["classified_modules"] == RUNTIME_QUARANTINE_CANDIDATES
