...
|---|---|---:|---:|---|
| RGP1 | Prove missing or invalid `PortfolioState` forces kill-switch activation and prevents runtime approval paths from treating `0.0` drawdown as valid governance | P0 | Critical | Started / wrapper + regression tests added |
