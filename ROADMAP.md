...
| RGP4 | Escalate Polygon/data-provider fetch failure for actionable signals into explicit degraded/fail evidence instead of silently skipping lifecycle evaluation | P0 | Critical | Implemented / CI-wired |
