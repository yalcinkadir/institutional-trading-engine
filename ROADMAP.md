...
| RGP6 | Remove silent notification masking for critical alerts by using strict notification mode and eliminating `|| true` from critical alert paths | P1 | High | Implemented / CI-wired |
