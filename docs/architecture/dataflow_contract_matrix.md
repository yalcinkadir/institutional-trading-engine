...
| `action` | `action` | yes | signal generator | validator/watcher/evidence | none | reject if missing | `tests/test_p161_dataflow_contract_matrix.py` |
| `decision` | `decision` | yes | decision engine / signal generator | validator/watcher/evidence | none | reject if missing | `tests/test_p161_dataflow_contract_matrix.py` |
| `entry_trigger` | `entry_trigger` | yes | signal generator | validator/watcher/backtest | none | reject if missing | `tests/test_p161_dataflow_contract_matrix.py` |
| `stop_loss` | `stop_loss` | yes | stop-loss quality | validator/watcher/backtest | none | reject if missing | `tests/test_p161_dataflow_contract_matrix.py` |
| `target_1` | `target_1` | yes | exit target quality | validator/watcher/backtest | none | reject if missing | `tests/test_p161_dataflow_contract_matrix.py` |
